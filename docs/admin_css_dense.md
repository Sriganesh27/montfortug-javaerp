# Merged `admin.css` (Dense & Theme-Matched)

You are completely right. I have stripped out the extra blues, removed the large backgrounds and shadows from the legends, and squeezed the paddings/margins dramatically to match the tight, slate-gray (`#cbd5e1`, `#475569`) layout of your existing theme.

Here is the fully merged, highly compact CSS. Replace your `admin.css` with this:
...
/* ========================================================= */
/* --- ADD EMPLOYEE: DENSE FIELDSET & GRID LAYOUTS ---       */
/* ========================================================= */
...
#ba-add-employee-view .emp-legend {
    ...
    font-size: 0.9rem;
    font-weight: 700;
    color: #475569; /* Slate 600 - Matches labels */
    border: none;
    background: transparent;
    box-shadow: none;
}

/* --- Dense Dynamic Sections Container --- */
...
/* Grid sizes for the dynamic rows - tightened */
#ba-add-employee-view .emp-grid-3-cols, #ba-employees-view .emp-grid-3-cols { grid-template-columns: repeat(3, 1fr) 28px; }
#ba-add-employee-view .emp-grid-4-cols, #ba-employees-view .emp-grid-4-cols { grid-template-columns: repeat(4, 1fr) 28px; }
#ba-add-employee-view .emp-grid-5-cols, #ba-employees-view .emp-grid-5-cols { grid-template-columns: repeat(5, 1fr) 28px; }

/* The Add "+ New" Buttons (Subtle, Slate color) */
