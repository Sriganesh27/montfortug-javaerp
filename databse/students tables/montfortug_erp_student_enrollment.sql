...
CREATE TABLE `erp_student_enrollment` (
  ...
  CONSTRAINT `erp_student_enrollment_ibfk_1` FOREIGN KEY (`branch_id`, `AdmissionNo`) REFERENCES `erp_students` (`branch_id`, `AdmissionNo`) ON DELETE CASCADE
...
-- Dump completed on 2026-07-03 15:11:41
