...
--
-- Dumping data for table `erp_alumni`
--

LOCK TABLES `erp_alumni` WRITE;
/*!40000 ALTER TABLE `erp_alumni` DISABLE KEYS */;
/*!40000 ALTER TABLE `erp_alumni` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2026-06-09 19:47:10
