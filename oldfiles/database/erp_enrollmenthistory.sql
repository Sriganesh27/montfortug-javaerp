...
--
-- Dumping data for table `erp_enrollmenthistory`
--

LOCK TABLES `erp_enrollmenthistory` WRITE;
/*!40000 ALTER TABLE `erp_enrollmenthistory` DISABLE KEYS */;
/*!40000 ALTER TABLE `erp_enrollmenthistory` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2026-06-09 19:47:19
