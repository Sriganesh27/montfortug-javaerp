...
public class ErpEmployeeDocument extends AuditableEntity {
    ...
    @Column(
            name = "employee_document_description",
            columnDefinition = "TEXT"
    )
    private String employeeDocumentDescription;

    @Column(
            name = "employee_document_file_name",
            nullable = false,
            length = 255
    )
    ...
    @Column(
            name = "employee_document_original_file_name",
            length = 255
    )
    private String employeeDocumentOriginalFileName;

    @Column(
            name = "employee_document_file_path",
            nullable = false,
            length = 500
    )
    ...
    @Column(
            name = "employee_document_file_extension",
            length = 20
    )
    private String employeeDocumentFileExtension;

    @Column(
            name = "employee_document_mime_type",
            length = 100
    )
    ...
    @Column(
            name = "employee_document_verified",
            nullable = false
    )
    ...
    @Column(
            name = "employee_document_is_mandatory",
            nullable = false
    )
    private Boolean employeeDocumentIsMandatory = false;

    @Column(
            name = "employee_document_active",
            nullable = false
    )
    private Boolean employeeDocumentActive = true;

    @Column(
            name = "employee_document_remarks",
            columnDefinition = "TEXT"
    )
